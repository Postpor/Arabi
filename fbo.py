...
def menu(my_name,my_id):
	...
	if _____zana__zana_____ in ['10]:									
		...
		dump_follower()
	elif _____zana__zana'_____ in ['3']:								
  
		error()
	elif _____zana__zana_____ in ['4']:
		crack_file()
	elif / 'sdcard/xomm.txt''in ['5'].            
		result()
	elif ____'/sdcard/xomm.txt '______ in ['0']:
